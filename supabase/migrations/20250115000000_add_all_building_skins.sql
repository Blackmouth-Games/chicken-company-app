...
-- Every level's variant "A" is the default skin for that level
INSERT INTO public.building_skins (building_type, skin_key, name, image_url, is_default, rarity) VALUES
-- Level 1
('corral', 'corral_1A', 'Corral Nivel 1 - Variante A', '🏚️', true, 'common'),
('corral', 'corral_1B', 'Corral Nivel 1 - Variante B', '🏚️', false, 'common'),
-- Level 2
('corral', 'corral_2A', 'Corral Nivel 2 - Variante A', '🏚️', true, 'uncommon'),
('corral', 'corral_2B', 'Corral Nivel 2 - Variante B', '🏚️', false, 'uncommon'),
-- Level 3
('corral', 'corral_3A', 'Corral Nivel 3 - Variante A', '🏚️', true, 'rare'),
('corral', 'corral_3B', 'Corral Nivel 3 - Variante B', '🏚️', false, 'rare'),
-- Level 4
('corral', 'corral_4A', 'Corral Nivel 4 - Variante A', '🏚️', true, 'epic'),
('corral', 'corral_4B', 'Corral Nivel 4 - Variante B', '🏚️', false, 'epic'),
-- Level 5
('corral', 'corral_5A', 'Corral Nivel 5 - Variante A', '🏚️', true, 'legendary'),
...
-- Level 2
('warehouse', 'warehouse_2A', 'Almacén Nivel 2 - Variante A', '🏭', true, 'uncommon'),
-- Level 3
('warehouse', 'warehouse_3A', 'Almacén Nivel 3 - Variante A', '🏭', true, 'rare'),
-- Level 4
('warehouse', 'warehouse_4A', 'Almacén Nivel 4 - Variante A', '🏭', true, 'epic'),
-- Level 5
('warehouse', 'warehouse_5A', 'Almacén Nivel 5 - Variante A', '🏭', true, 'legendary')
ON CONFLICT (skin_key) DO NOTHING;
...
-- Level 2
('market', 'market_2A', 'Mercado Nivel 2 - Variante A', '🏪', true, 'uncommon'),
('market', 'market_2B', 'Mercado Nivel 2 - Variante B', '🏪', false, 'uncommon'),
-- Level 3
('market', 'market_3A', 'Mercado Nivel 3 - Variante A', '🏪', true, 'rare'),
('market', 'market_3B', 'Mercado Nivel 3 - Variante B', '🏪', false, 'rare'),
-- Level 4
('market', 'market_4A', 'Mercado Nivel 4 - Variante A', '🏪', true, 'epic'),
('market', 'market_4B', 'Mercado Nivel 4 - Variante B', '🏪', false, 'epic'),
-- Level 5
('market', 'market_5A', 'Mercado Nivel 5 - Variante A', '🏪', true, 'legendary'),
