  ...
  if (building) {
    ...
    return (
      <div className="relative">
        ...
        {/* Mini horizontal conveyor belt to connect to vertical belt */}
        <div 
          className={cn(
            "absolute top-1/2 -translate-y-1/2 h-6 bg-gradient-to-r from-amber-800 to-amber-900 shadow-lg z-0 flex items-center justify-center",
            isLeftColumn ? "-right-8 w-8 rounded-r-lg" : "-left-8 w-8 rounded-l-lg"
          )}
        >
